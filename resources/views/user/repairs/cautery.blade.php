                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="serv-sec xs-mb-0">
                                    <img class="banner-img img-thumbnail" src="{{asset('assets/HelthcareImages/Cautery Machine/daiwha-400s.webp')}}" alt="">
                                    <div class="detail" style="background: #25255b;margin: 0;padding: 25px;text-align: center;">
                                        <h5 style="color:#fff">Daiwha-400s</h5>
                            ...
                            <div class="col-md-4">
                                <div class="serv-sec xs-mb-0">
                                    <img class="banner-img img-thumbnail" src="{{asset('assets/HelthcareImages/Cautery Machine/electro-surgical-coutry-machine.png')}}" alt="">
                                    <div class="detail" style="background: #25255b;margin: 0;padding: 25px;text-align: center;">
                                        <h5 style="color:#fff">Electro Surgical Coutry Machine</h5>
                            ...
                            <div class="col-md-4">
                                <div class="serv-sec xs-mb-0">
                                    <img class="banner-img img-thumbnail" src="{{asset('assets/HelthcareImages/Cautery Machine/High-Frequency-Electrosurgical-Cautery-Machine.jpg')}}" alt="">
                                    <div class="detail" style="background: #25255b;margin: 0;padding: 25px;text-align: center;">
                                        <h5 style="color:#fff">High Frequency Electrosurgical Cautery Machine</h5>
