            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-title text-center">
                        <h2><span>Pressure Injector </span></h2>
                        <span></span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="serv-sec xs-mb-0">
                                <img class="banner-img img-thumbnail" src="{{asset('assets/HelthcareImages/PRESSURE INJECTOR/Presssur Injector.jpg')}}" alt="">
                        ...
                        <div class="col-md-4">
                            <div class="serv-sec xs-mb-0">
                                <img class="banner-img img-thumbnail" src="{{asset('assets/HelthcareImages/PRESSURE INJECTOR/Presssur Injector-1.jpg')}}" alt="">
                                <div class="detail" style="background: #25255b;margin: 0;padding: 25px;text-align: center;">
                                    <h5 style="color:#fff">Ultrasound</h5>
                                </div>
                            </div>
