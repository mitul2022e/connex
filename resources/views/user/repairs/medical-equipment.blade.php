            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-title text-center">
                        <h2><span>Other Medical Equipment</span></h2>
                        <span></span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="serv-sec xs-mb-0">
                                <img class="banner-img img-thumbnail" src="{{asset('assets/HelthcareImages/OTHER MEDICAL EQUIPMENT/Other Medical.jpg')}}" alt="">
