                    ...
                    <div class="col-md-12">
                        <div class="detail">
                            ...
                            <p class="text-justify xs-pt-30">
                                Argon Medical Systems offers you Both Nemoto and Medraed Single channel and double channel injector for your CT scan System at good price.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="serv-sec xs-mb-0">
                                <img class="banner-img img-thumbnail" src="{{asset('assets/HelthcareImages/LIGHT SOURCE/LightSource.jpg')}}" alt="">
